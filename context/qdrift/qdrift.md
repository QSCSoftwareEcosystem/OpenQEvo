...
| :--- | :--- | :--- |
| **Total Gate Count ($N$)** | $O\left(\frac{L^3 (\Lambda t)^2}{\epsilon}\right)$  | $O\left(\frac{\lambda^2 t^2}{\epsilon}\right)$ (Campbell, 2019) |
